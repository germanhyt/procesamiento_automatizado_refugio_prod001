    ...
    const columns = useMemo(
        () => [
            ...
            columnHelper.accessor('tipo_evento', {
                header: 'Tipo',
                cell: (i) => <span className="text-[10px] font-bold text-teal-400/90">{i.getValue()}</span>,
            }),
        ...
        <div className="space-y-4">
            <div className="flex flex-col lg:flex-row gap-3 lg:items-end lg:justify-between">
                <div className="flex flex-wrap gap-2 items-center">
                    <Cake size={18} className="text-teal-500 shrink-0" />
                    <input
            ...
            >
                ...
                {isError && (
                    <p className="p-6 text-red-400 text-sm">Error cargando eventos. ¿Permiso comercial:view?</p>
                )}
                {isLoading ? (
                    ...
                    <table className="w-full text-sm">
                        <thead>
                            {table.getHeaderGroups().map((hg) => (
                                <tr
                                    key={hg.id}
                                    className="border-b text-left text-[10px] font-black uppercase tracking-widest text-app-muted"
