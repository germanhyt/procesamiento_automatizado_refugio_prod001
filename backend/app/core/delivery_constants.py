...
# Centro de control — umbrales de alerta (minutos)
CONTROL_ALERT_ORDER_NO_RUNNER_MINUTES = 15
CONTROL_ALERT_ORDER_LISTO_NO_MATCH_MINUTES = 20
CONTROL_ALERT_MATCH_NO_DELIVERY_MINUTES = 25
CONTROL_ALERT_DRIVER_WAITING_MINUTES = 10

# Tipos de alerta (control/snapshot)
CONTROL_ALERT_ORDER_NO_RUNNER = "ORDER_NO_RUNNER"
CONTROL_ALERT_ORDER_LISTO_NO_MATCH = "ORDER_LISTO_NO_MATCH"
CONTROL_ALERT_MATCH_NO_DELIVERY = "MATCH_NO_DELIVERY"
CONTROL_ALERT_DRIVER_WAITING_LONG = "DRIVER_WAITING_LONG"

# WebSocket — centro de control
EVENT_CONTROL_SNAPSHOT_CHANGED = "CONTROL_SNAPSHOT_CHANGED"
...
PERMISSION_DELIVERY_CONTROL = "delivery:control"
PERMISSION_DELIVERY_CONTROL_ACTIONS = "delivery:control:actions"
PERMISSION_DELIVERY_SIMULATE_ORDER_READY = "delivery:simulate_order_ready"

# Auditoría centro de control — fuentes y acciones
DELIVERY_AUDIT_SOURCE_CONTROL = "control_center"
DELIVERY_AUDIT_SOURCE_ADMIN = "admin_panel"
DELIVERY_AUDIT_ACTION_UNLOCK = "UNLOCK"
DELIVERY_AUDIT_ACTION_CANCEL = "CANCEL"
DELIVERY_AUDIT_ACTION_FORCE_ENTREGADO = "FORCE_ENTREGADO"
DELIVERY_AUDIT_ACTION_MARK_DEVOLUCION = "MARK_DEVOLUCION"
DELIVERY_AUDIT_ACTION_MANUAL_MATCH = "MANUAL_MATCH"
DELIVERY_AUDIT_ACTION_UPDATE_ORDER = "UPDATE_ORDER"
DELIVERY_AUDIT_HEADER = "X-Delivery-Audit-Source"
